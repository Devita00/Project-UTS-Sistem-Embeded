...
int FLAME_SENSOR_serial_data_R1;
...
void loop()
{
  ...
  {
    lcd.clear();
    FLAME_SENSOR_serial_data_R1=10;
    Serial.write(FLAME_SENSOR_serial_data_R1);
  }
  else
  {
    lcd.clear();
    FLAME_SENSOR_serial_data_R1=20;
    Serial.write(FLAME_SENSOR_serial_data_R1);
  }
  ...
  else
  {
    ...
    {
      int FLAME_SENSOR_serial_data_R2= Serial.read();
